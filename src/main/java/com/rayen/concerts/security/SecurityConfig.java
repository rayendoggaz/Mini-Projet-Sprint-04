...
public class SecurityConfig {
	...
	@Bean
	 SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {      
		 	 http.authorizeHttpRequests((requests)->requests
	                		...
	                		.requestMatchers("/ListeConcerts").hasAnyAuthority("ADMIN","AGENT","USER")
	 ...
	 * authorities("ADMIN") .build(); UserDetails userRayen =
	 * User.withUsername("rayen").password(passwordEncoder.encode("123"))
